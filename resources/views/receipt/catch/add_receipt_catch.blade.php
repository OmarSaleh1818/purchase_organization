...
@section('content')
    ...
    <form method="post" action="{{ route('receipt.catch.store', $catch->id) }}">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="company_name" value="{{ $catch['company']['company_name'] }}" readonly>
                    @error('company_name')
                    <span class="text-danger"> {{ $message }}</span>
                    @enderror
                </div>
