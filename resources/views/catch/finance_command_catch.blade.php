...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الادارة المالية</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ امر قبض</span>
            </div>
        </div>
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap">
                            ...
                            @foreach($catches as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('finance.catch.edit', $item->id) }}" class="btn btn-info"
