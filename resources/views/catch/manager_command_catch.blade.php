...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المدير العام</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ امر قبض</span>
            </div>
        </div>
                            ...
                            @foreach($catches as $key => $item)
                                @if($item->status_id == 6)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('manager.catch.edit', $item->id) }}" class="btn btn-info"
