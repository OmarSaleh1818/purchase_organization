...
@section('content')
    ...
    <form method="post" action="{{ route('catch.store') }}">
        @csrf
        <div class="row">
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="gentlemen" required placeholder="السيد / السادة...">
                    @error('gentlemen')
                    <span class="text-danger"> {{ $message }}</span>
                    @enderror
                </div>
        ...
        <div class="d-flex justify-content-between">
            <input type="submit" class="btn btn-info" value="ارسال امر القبض">
        </div>
        <br>
    </form>
