            ...
            <div class="card mg-b-20">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('subcompany.update', $subcompany->id) }}">
                        ...
                        <div class="form-group">
                            <label>اسم المركز الرئيسي</label><span style="color: red;">  *</span>
                            <input type="text" class="form-control" name="subcompany_name" value="{{ $subcompany->subcompany_name }}" placeholder="اسم المركز الرئيسي...">
                            @error('subcompany_name')
                            <span class="text-danger"> {{ $message }}</span>
                            @enderror
                        </div>
                        <div class="d-flex justify-content-between">
                            <input type="submit" class="btn btn-info" value=" تعديل اسم المركز الرئيسي">
                        </div>
                        <br>
                    </form>
                </div>
