...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المدير العام</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ امر دفع نقدي/بنكي</span>
            </div>
        </div>
                            ...
                            @foreach($paymentOrder as $key => $payment)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($payment->status_id == 1)
                                            <a href="{{ route('print.command', $payment->id) }}" class="btn btn-secondary"
                                               title="طباعة"><i class="fa fa-print"></i></a>
                                        @else
                                            <a href="{{ route('print.command', $payment->id) }}" class="btn btn-warning"
                                               title="طباعة"><i class="fa fa-print"></i></a>
                                        @endif
                                    </td>
                                    <td>
                                        <a href="{{ route('manager.command.edit', $payment->id) }}" class="btn btn-info"
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <a href="{{ route('manager.command.sure', $payment->id) }}" class="btn btn-primary">تاكيد الطلب</a>
                                        @endif
                                    </td>
                                    <td></td>
                                </tr>
                                ...
                                @elseif($payment->status_id == 3)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-dark">تم اضافة سند صرف</button>
                                        </td>
                                        <td></td>
                                    </tr>
                                @endif
