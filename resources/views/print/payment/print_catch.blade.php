...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المحاسبة</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/طباعة امر قبض</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <div class="card-body">
                        <div class="invoice-header">
                            ...
                            <div class="billed-from">
                                <h3 style="margin-right: 250px; margin-top: 40px">{{ $catch['company']['company_name'] }}</h3>

                            </div><!-- billed-from -->
                        </div><!-- invoice-header -->
                        <h1 class="invoice-title" style="text-align: center">امر قبض</h1>
                        <br>
                        ...
                        <h4 class="invoice-info mr-5"><span>السيد / السادة :</span>
