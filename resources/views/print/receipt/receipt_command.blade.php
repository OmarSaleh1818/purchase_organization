...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الخزنة</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/طباعة امر سند صرف</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class=" main-content-body-invoice" id="print">
                <div class="card card-invoice">
                    <div class="card-body">
                        ...
                        <h1 class="invoice-title" style="text-align: center">امر سند صرف</h1>
                        <br>
                        ...
                        <h4 class="invoice-info mr-5"><span>المستفيد :</span>
                            <span style="margin-right: 80px;border-style: double">{{ $receipt->benefit_name }} </span></h4>
                        <div class="row mg-t-20">
                            <div class="col-md mr-5">
                                <br>
                                <br>
                        ...
                        <h4 class="invoice-info mr-5"><span>فقط :</span>
                            <span style="margin-right: 80px;border-style: double">{{ $receipt->just }} </span></h4>
                        <br>
                        <br>
                        <div class="row mg-t-20">
                            <div class="col-md mr-5">
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                ...
                                <h4 class="invoice-info"><span>رقم :</span>
                                    <span style="margin-right: 50px; border-style: double">{{ $receipt->number_financial }}</span></h4>
                            </div>
                        </div>
                        <br>
                        <h4 class="invoice-info mr-5"><span>البيان :</span>
                            <span style="margin-right: 100px;border-style: double">{{ $receipt->purchase_name }} </span></h4>
                        <br>
                        <br>
                        <div class="row mg-t-20">
                            <div class="col-md mr-5">
