...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الادارة المالية</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ سندات القبض</span>
            </div>
        </div>
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap">
                            ...
                            @foreach($catches as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('financial.catch.edit', $item->id) }}" class="btn btn-info"
                                           title="edit data"><i class="las la-pen"></i></a>
                                    </td>
                                    <td>
                                        @if($item->status_id == 1)
                                            <a href="{{ route('financial.catch.sure', $item->id) }}" class="btn btn-primary">تأكيد الطلب</a>
...
@section('js')
    <script>
        ...
        $(document).ready(function () {
            $.get("/finance/getFinanceCatchByCompany/"+id,function (data) {
